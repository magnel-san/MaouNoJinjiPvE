namespace Game.HandTracking
{
    ...
    public enum HandPose
    {
        ...
        Scissors,  // チョキ(人差し指+中指の2本のみ伸展、親指は屈曲) → 回復(持続効果、UpdateHealPulse参照)
        ThumbUp,    // グッドサイン(親指のみ伸展・上向き、他4指は屈曲) → keyboard4 (ボス以外集中攻撃/雑魚攻撃)
        ThumbDown,  // バッドサイン(親指のみ伸展・下向き、他4指は屈曲) → keyboard3 (ボス集中攻撃)
